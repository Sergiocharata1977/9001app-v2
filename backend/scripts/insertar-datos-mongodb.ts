...
/**
 * Script de inserción de datos en MongoDB
 * Sistema de Gestión de Calidad ISO 9001
 * 
 * Este script elimina completamente Turso y usa solo MongoDB
 * para insertar datos de ejemplo en todas las colecciones
 */
...
class DataInserter {
  ...
  async ejecutar(): Promise<void> {
    try {
      this.logger.log('🚀 Iniciando inserción de datos en MongoDB...');
      ...
      this.logger.log('🎯 MongoDB configurado y funcionando correctamente');
