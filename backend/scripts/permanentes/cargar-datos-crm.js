...
async function cargarDatosCRM() {
  try {
    ...
    // Verificar clientes
    const clientesCount = await mongodbClient.execute({
    ...
    const oportunidadesCount = await mongodbClient.execute({
    ...
    const actividadesCount = await mongodbClient.execute({
    ...
    const statsClientes = await mongodbClient.execute({
    ...
    const statsOportunidades = await mongodbClient.execute({
