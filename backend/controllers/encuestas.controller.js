...
const createEncuesta = async (req, res) => {
  ...
  try {
    ...
    if (newId) {
      const newEncuestaResult = await mongodbClient.execute({
...
const updateEncuesta = async (req, res) => {
  ...
  try {
    ...
    const updatedEncuestaResult = await mongodbClient.execute({
      sql: 'SELECT * FROM encuestas WHERE id = ?',
      args: [id],
    });
...
const addRespuesta = async (req, res) => {
  ...
  try {
    const encuestaResult = await mongodbClient.execute({
