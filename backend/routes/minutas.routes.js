...
router.get('/', async (req, res) => {
  try {
    ...
    try {
      ...
      const tableCheck = await mongodbClient.execute({
...
router.post('/', async (req, res) => {
  try {
    ...
    const createdMinuta = await mongodbClient.execute({
...
router.put('/:id', async (req, res) => {
  try {
    ...
    const existingMinuta = await mongodbClient.execute({
      sql: `SELECT * FROM minutas WHERE id = ?`,
      args: [id]
    });
    ...
    const updatedMinuta = await mongodbClient.execute({
      sql: `SELECT * FROM minutas WHERE id = ?`,
      args: [id]
    });
...
router.get('/:id/historial', async (req, res) => {
  try {
    ...
    const minuta = await mongodbClient.execute({
      sql: `SELECT * FROM minutas WHERE id = ?`,
      args: [id]
    });
...
router.post('/:id/duplicate', async (req, res) => {
  try {
    ...
    const duplicatedMinuta = await mongodbClient.execute({
      sql: `SELECT * FROM minutas WHERE id = ?`,
      args: [result.lastInsertRowid]
    });
...
router.post('/:id/participantes', async (req, res) => {
  try {
    ...
    // Verificar que la minuta existe
    const minutaExists = await mongodbClient.execute({
    ...
    const createdParticipante = await mongodbClient.execute({
...
router.post('/:id/documentos', async (req, res) => {
  try {
    ...
    const createdDocumento = await mongodbClient.execute({
...
router.post('/:id/normas', async (req, res) => {
  try {
    ...
    const createdNorma = await mongodbClient.execute({
