...
router.post('/', async (req, res, next) => {
  ...
  try {
    ...
    const existing = await mongodbClient.execute({
    ...
    const columnsInfo = await mongodbClient.execute({
...
router.put('/:id', async (req, res, next) => {
  ...
  try {
    ...
    const prevResult = await mongodbClient.execute({
    ...
    const updatedDeptResult = await mongodbClient.execute({
      sql: 'SELECT * FROM departamentos WHERE id = ?',
      args: [id],
    });
...
router.delete('/:id', async (req, res, next) => {
  ...
  try {
    ...
    const puestosCheck = await mongodbClient.execute({
    ...
    const personalCheck = await mongodbClient.execute({
