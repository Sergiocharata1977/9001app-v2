...
class DatabaseSetupService {
    ...
    async createTable(tableName, columns) {
        try {
            ...
            const result = await this.mongoClient.execute(query);
            return {
                success: true,
    ...
    async insertData(tableName, data) {
        try {
            ...
            const result = await this.mongoClient.execute(query, values);
            return {
                success: true,
    ...
    async tableExists(tableName) {
        try {
            ...
            const result = await this.mongoClient.query(query, [tableName]);
            return {
    ...
    async getTableStructure(tableName) {
        try {
            ...
            const result = await this.mongoClient.query(query);
            return {
                success: true,
                structure: result,
